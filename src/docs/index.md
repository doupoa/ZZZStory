...
<div class="flex flex-col">
  <div class="relative mx-auto mt-12 flex-1 px-6 lg:mt-20 lg:px-16 z-1">
    <div
    ...
    >
      ...
      <!-- 右侧 logo -->
      <div
        class="flex my-8 justify-center lg:mt-0 lg:ml-56 lg:flex-1"
      >
        <div class="relative">
          <div
  ...
  <footer class="w-full py-6 lg:fixed lg:bottom-0 z-1">
    <div
...
<!-- 全屏背景层 -->
<div v-if="isDark" class="fixed inset-0 z-0 hidden lg:block">
  <ColorBends
    :rotation="0"
    :autoRotate="2"
    :speed="0.15"
